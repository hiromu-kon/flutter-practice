...
class _$_Account implements _Account {
  ...
  @override
  String toString() {
    return 'Account(id: $id, name: $name, imagePath: $imagePath, selfIntroduction: $selfIntroduction, userId: $userId, createdTime: $createdTime, updatedTime: $updatedTime)';
  }
...
abstract class _Account implements Account {
  const factory _Account(
      ...
      required final DateTime updatedTime}) = _$_Account;
